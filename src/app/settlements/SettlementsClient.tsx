  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200">
        <div className="px-4 md:px-8 py-4 md:py-6 flex justify-between items-center">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <div className="text-xl md:text-2xl font-light tracking-wider text-black">SETTLEMENTS</div>
              <div className="text-xs md:text-sm font-light text-gray-600 mt-1">{member.company_name}</div>
            </div>
          </div>
          <div className="text-xs md:text-sm font-light text-black hidden sm:block">{userEmail}</div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        ...
        {/* Settlement History */}
        <div>
          <h2 className="text-xl md:text-2xl font-light mb-4 md:mb-6 text-black">Settlement History</h2>
                ...
                return (
                  <div key={cycleId} className="border border-gray-200">
                    ...
                    <button
                      ...
                      className="w-full px-4 md:px-6 py-4 md:py-5 flex flex-col md:flex-row justify-between md:items-center hover:bg-gray-50 transition-colors text-left gap-4"
                    >
                      <div className="flex items-center gap-4 md:gap-6">
                        <div>
                          <div className="flex items-center gap-2 md:gap-3 mb-2">
                            <Calendar size={16} strokeWidth={1} className="text-black" />
                            <div className="text-base md:text-lg font-light text-black">
                      ...
                      <div className="flex items-center justify-between md:justify-end gap-4 md:gap-8">
                        <div className="text-left md:text-right">
                          ...
                          <div className={`text-lg md:text-xl font-light ${netAmount >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        {/* Info Box */}
        {cycles.length > 0 && (
          <div className="mt-8 md:mt-12 border border-gray-200 p-4 md:p-6 bg-gray-50">
            <h3 className="text-base md:text-lg font-light mb-3 md:mb-4 text-black">About Your Settlements</h3>
            <div className="space-y-3 text-xs md:text-sm font-light text-gray-700">
              <p>
